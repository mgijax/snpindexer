...
public enum IndexerConfig {
	...
	ConsensusSNPIndexer("ConsensusSNPIndex", ConsensusSNPIndexer.class, 25000, 120000, 50000),
	SearchSNPIndexer("SearchSNPIndex", SearchSNPIndexer.class, 4000, 30000, 50000)
	;
