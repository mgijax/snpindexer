...
@NamedQueries({
	@NamedQuery(name="mgdaccessionobject", query="select a from MGDAccessionObject a where a.objectKey = :key and a.logicalDBKey = :logicalDBKey and a.mgiTypeKey = :mgiTypeKey and preferred=1"),
})

@Entity
@Table(name="mgd.acc_accession")
public class MGDAccessionObject extends SNPEntity implements Serializable {
